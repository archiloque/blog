...
Comme dans le cas des villes, les premiers temps d'urbanistes "tour d'ivoires" ont laissé la place à une décentralisation :
...
l'objectif étant qu'ils soient plus pérennes que les services standards, les migrations étant plus compliquées.
