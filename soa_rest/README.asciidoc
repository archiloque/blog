...
La cible n'est pas de seulement se mettre d'accord sur les besoin, mais de définir ensemble la totalité des contrats de service : 
signatures des appels, volumétrie et SLA.
...
L'enjeux de ces pratiques n'est pas technique mais organisationnelle,
elles nécéssitent de faire travailler ensemble les différents projets. 
