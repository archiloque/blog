...
:article_lang: en
:figure-caption!:
:article_description: Small scripts, build systels, LLVM instruction scheduling, Java exceptions compilation, recursive macros in C, UI framework, reading code
...
== link:https://h4x0r.org/big-mac-ro-attack/[Recursive macros in C, demystified (once the ugly crying stops 😭)]
