...
== link:https://danluu.com/learning-to-program/[How I learned to program]

[quote]
____
I've never seen an environment go from "`bad`" to "`good`" and I'd be curious to know what that looks like and how it happens. Yossi Kreinin's thesis is that link:http://yosefk.com/blog/people-can-read-their-managers-mind.html[only management can fix broken situations]. That might be true, but I'm not quite ready to believe it just yet, even though I don't have any evidence to the contrary.
