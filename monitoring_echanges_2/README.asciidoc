...
Cette solution est la plus conforme, trois points sont à vérifier avant de vous lancer:

- la documentation qui couvre ces parties n'est pas toujours très fournie et les exemples sont souvent limités
- ces API sont souvent proches du moteur des outils et à ce titre plus suceptibles de ne pas être compatibles d'une version à l'autre
-  les informations dont vous avez besoin sont-elles toutes disponibles
