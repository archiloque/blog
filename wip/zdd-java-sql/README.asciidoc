...
Pour sortir de cette impasse, cet article présenter un cas pratique, code à l'appui.
...
Le code est en open-source sous licence MIT, vous pouvez donc vous servir.
