...
Dans le cas idéal, les différents métier impliqués ont l'haitude de travailler ensemble, et sauront prioriser les demandes d'une manière qui soit acceptable aux différentes parties prenantes.

Dans d'autre cas, cela peut signifier que différentes branches du métier doivent apprendre à travailler ensemble pour des raisons d'IT, alors qu'elles n'ont que rarement à le faire par ailleurs.

Par expérience cet apprentissage est souvent difficile, en particulier lorsqu'un des métier à plus d'intérêt que les autres à cette collaboration.

QQQQ a priori on ne devrait pas avoir de liens côté projets entre deux métiers qui ne soient pas drivée par des liens métiers, mais ça peut arriver
identifier quand des liens se tissent et n'ont pas été identifés avant et que les métiers ne s'entendent pas, voir si c'est une bonne idée ou s'il faut renoncer.
