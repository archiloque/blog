...
Rappellez vous que la vitesse d'évolution d'un système est limitée par le composant qui bouge le moins vite.
Dans mon expérience, c'est souvent la gestion des dépendances qui est en cause.

Essayez d'optimiser les choses au mieux pour chaque projet, sans attendre une solution globale qui résoudrait tout.
...
L'article contient des propositions d'action en fonction de votre rôle dans votre structure, vous n'avez plus qu'à vous lancer.