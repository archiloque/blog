...
Pour les demandes d'une taille plus réduite, les décisions peuvent être déléguées aux projets, sous conditions que le résultat soient satisfaisants. Cela permet de limiter le coût organisationnel.

Il s'agit probablement d'un des changements les plus compliqués à opérer dans une organisation.
La DSI peut avoir un rôle à jouer pour convaincre et accompagner.
