...
avec les dépendances il n'est pas possible d'être en capacité d'avoir un TTM bas en s'appuyant sur des cycles courts et en ayant la maîtrise de ce que l'on fait.
Dans cette situation, les promesses de l'agile ne sont pas remplies.
