...
Ensuite le calendrier de déploiement sur l'environnement de recette doit correspondre au calendrier de mise en production. Par exemple prenons deux applications A et B, B utilisant des services de A.
