...
Ensuite nous verrons comment et à quel rythme exposer ces services, et en cas de besoin, comment faire quand un consommateur de service ne plus évoluer ?
Pour finir sur les questions de budgets.
...
=== Nombre de versions majeures à maintenir en parallèle

Le choix du nombre de versions majeures à maintenir en parallèle est un arbitrage entre le fournisseur de services et les consommateurs :
