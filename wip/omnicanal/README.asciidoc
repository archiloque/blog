...
À l'inverse, un SI multicanal fournit les même fonctionnalités sur plusieurs canaux mais de manière silotée, et la bascule d'un canal à l'autre est donc visible de la part des personnes ou des systèmes qui l'utilisent.
