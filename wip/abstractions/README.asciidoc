...
*difficile de prévoir ce qui arrive aux effets de bords*
*composer : il vaut mieux choisir des systèmes qui ont des frontières cohérentes*
...
*minimiser à la fois les frontières et les types frontières différentes*
