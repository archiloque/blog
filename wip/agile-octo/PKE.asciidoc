...
Aujourd'hui l'agile s'applique à l'intégralité de la chaîne depuis le métier jusqu'à la production, alors qu'à l'époque le périmètre était beaucoup plus restreint.
