...
On avait entendu parler de link:https://fr.wikipedia.org/wiki/Extreme_programming[l'extreme programming (XP)], certaines personnes avaient des pratiques de développement autour du test automatisé ou de la qualité, mais on ne parlait pas d'agile en tant que tel. Sur la méthode ça se limitait en gros à Scrum.
