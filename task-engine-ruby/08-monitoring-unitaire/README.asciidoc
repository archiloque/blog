...
Avec le temps la table `tasks` devrait contenir de plus en plus d'occurences de tâches terminées (avec l'hypothèse que le nombre de tâches à exécuter devrait rester raisonable).
