[#MDT-4]
ifeval::["{doctype}" == "book"]
= Partie 4 : {article-4-nom}
endif::[]
ifeval::["{doctype}" != "book"]
= {titre-série} partie 4 : {article-4-nom}
endif::[]

ifeval::["{doctype}" != "book"]
Ceci est le quatrième article d'une série de XXX décrivant pas à pas comment écrire un {mdt} en Ruby.

Après avoir link:../{article-3-url}[mis en place la persistance] je vais m'intéresser maintenant à l'arrêt et au redémarrage.
endif::[]
...
ifeval::["{doctype}" != "book"]
link:../{article-5-url}/[Dans l'article suivant]
endif::[]
