...
ifeval::["{doctype}" == "book"]
Dans la partie suivante je vais m'intéresser à l'extinction du moteur.
endif::[]
ifeval::["{doctype}" != "book"]
link:../moteur-de-taches-en-ruby-4-extinction/[Dans l'article suivant] je vais m'intéresser à l'extinction et et au redémarrage.
endif::[]