[#MDT-5]
ifeval::["{doctype}" == "book"]
= Partie 5 : {article-5-nom}
endif::[]
ifeval::["{doctype}" != "book"]
= {titre-série} partie 5 : {article-5-nom}
endif::[]

ifeval::["{doctype}" != "book"]
Ceci est le cinquième article d'une série de XXX décrivant pas à pas comment écrire un {mdt} en Ruby.

Après m'être occupé de link:../{article-4-url}[l'arrêt et du redémarrage] je vais m'intéresser maintenant au paramétrage des tâches.
endif::[]
...
ifeval::["{doctype}" != "book"]
link:../{article-6-url}/[Dans l'article suivant]
endif::[]
