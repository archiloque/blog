[#MDT-2]
ifeval::["{doctype}" == "book"]
= Partie 2 : {article-2-nom}
endif::[]
ifeval::["{doctype}" != "book"]
= {titre-série} partie 2 : {article-2-nom}
endif::[]

ifeval::["{doctype}" != "book"]
Ceci est le deuxième article d'une série de XXX décrivant pas à pas comment écrire un {mdt} en Ruby.

Après link:../{article-1-url}[avoir introduit le sujet], je vais maintenant construire la base de la boucle de traitement.
endif::[]
...
ifeval::["{backend}" != "docbook5"]
image::{article-2-url}/workflow.svg[scaledwidth=50%,align="center"]
endif::[]
...
ifeval::["{doctype}" != "book"]
link:../{article-3-url/[Dans l'article suivant]
endif::[]
je vais m'intéresser au stockage des tâches pour que les workers aillent chercher ce qu'ils ont à faire.