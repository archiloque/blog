...
Utiliser ces compétences n'est donc pas forcément toujours le bon choix pour votre carrière, mais je suis persuadé que pouvoir compter dessus quand c'est nécessaire est très utile, et que cela justifie d'investir le temps nécessaire pour les maîtriser.
