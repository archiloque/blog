...
La tension entre une connaissance pratique, qui s'enrichit localement dans des "projet-laboratoire" s'oppose bien à une approche plus transportable et universelle.
