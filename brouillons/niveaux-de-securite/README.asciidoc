...
Je ne connais pas l'écosystème Android donc je ne sais pas si cette fonctionnalité y est utilisée, mais côté serveur elle l'était, par exemple pour permettre à des hébergeurs de partager un même serveur d'application entre plusieurs client·e·s quand cette approche avait du sens.
