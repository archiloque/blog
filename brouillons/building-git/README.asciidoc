...
Pour finir un avertissement{nbsp}: il semblerait qu'une partie non négligeable des personnes lisant le livre se soient lancé dans le projet de réimplémenter à leur tour Git dans le language de leur choix.