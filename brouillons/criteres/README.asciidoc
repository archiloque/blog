...
_Ceci est la suite de mes réflexions sur link:../agile-questionnement-institution/[l'agile] et les link:../legitimite/[pratiques] de link:../test-peur/[développement].
