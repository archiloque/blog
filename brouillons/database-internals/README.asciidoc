...
Dans son introduction Alex Petrov mène une réflexion sur un sujet inédit pour moi : la difficulté d'écrire des livres de niveau intermédiaire, c'est-à-dire s'adressant à des personnes ayant déjà des connaissances sur un sujet et souhaitant les approfondir, mais sans aller jusqu'à l'expertise.
...
Ensuite les différentes familles algorithmes de traitements distribués sont passés en revue : Paxos, Raft …
J'ai été frustré car on n'y parle que concept et théorie et pas du tout implémentation, mais j'ai été agréablement surpris de tomber sur ce tour d'horizon.
