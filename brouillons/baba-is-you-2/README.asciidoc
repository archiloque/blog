...
A FIFO may find a solution faster but the solution may be not be the shortest, a stack finds the solution that requires the lowest number of move, but requires more time and memory.
