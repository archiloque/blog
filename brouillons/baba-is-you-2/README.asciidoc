...
Which works better depends on the game I'm solving. Rather than choose by a fixed criterion, I just start from something that makes sense and tweak as I go. 
