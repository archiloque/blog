...
At first if will only contain the information found while reading the level from disk. I know from experience that I'll add other data to make the calculations simpler and/or faster.
