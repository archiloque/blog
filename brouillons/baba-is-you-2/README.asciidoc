...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: app1.java, fifoqueue1.java, graph1.mmd, graph1.png, level1.java, level2.java, log1.txt, state1.java
...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-2/graph1.png[width=730,height=498,align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-2/graph1.svg[width=784,height=468,align="center"]
endif::[]
