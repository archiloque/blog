...
At first it will only contain the information found while reading the level from disk. I know from experience that I'll add other data to simplify and speed up the calculations.
