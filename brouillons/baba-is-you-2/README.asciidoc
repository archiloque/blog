...
and that the changing rules thingie can be dealt with later.
...
That's it for the moment, in the next part we'll start adding some logic in the code to make good use of all this plumbing.