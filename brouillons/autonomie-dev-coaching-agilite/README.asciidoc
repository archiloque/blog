...
Les discussions autour de l'artisanat logiciel en sont un bon exemple : en mettant en avant l'importance des outils et donc l'importance de choisir les bons outils pour le bon usage, cela peut permettre aux devs de choisirs leurs propres outils.
...
Les raisons sont multiples : parce qu'on pense que le système sait mieux que les personnes, parce que des devs autonomes vont être plus diffaciles à manager …
