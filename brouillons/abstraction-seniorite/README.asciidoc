...
Une abstraction peut aussi introduire des inefficacités{nbsp}: en présentant un modèles simplifié elle peuvent permettre de gagner du temps au détriment d'une solution fait-main.
...
Plus ont a d'expérience avec les bases de données et le SQL, plus on a conscience des limites ou simplement des imperfections des ORMs, qui correspond à l'écart entre ce que l'outil fait et ce qu'on pourrait faire à la place de l'outil.
...
Dans mon expérience personnelle, ces mêmes personnes -- souvent des personnes ayant de l'expérience et donc un certain type d'influence -- ont du mal à concevoir qu'on puisse ne pas partager leur avis{nbsp}: si on n'est pas d'accord avec elle c'est par ignorance.
...
Il est toujours tentant de rejeter une solution existante mais imparfaite pour quelque chose qu'on pense savoir mieux faire soit même.
...
Mais parfois c'est le cas, la seniorité c'est aussi savoir faire des compromis, et accepter de ne pas faire partie de certains clubs.