= Pair-programming{nbsp}: c'est pas comme de codeer seul mais ensemble
Julien Kirch
v0.1, 2022-02-27
:article_lang: fr
...
- le sentiment de travailler beaucoup moins vite que si j'étais seul ce qui créé de la frustration, même si elle tempéré par l'idée qu'au final le résultat obtenu devrait être de meilleure qualité.
