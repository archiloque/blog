...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: app2.java, app3.java, level4.java, log3.txt, log4.txt, log5.txt, state5.java, state6.java
...
where I solved the first level, we'll make the solution readable.
...
Then when the solution is found, we can pretty print the path.
