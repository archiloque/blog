...
Si vous déjà assisté à une présentation sur l’organisation de projet, on vous a certainement présenté une slide sur les méfait du multi-tache pour les développeurs. Malheureusement cette démonstration ne repose sur rien.
