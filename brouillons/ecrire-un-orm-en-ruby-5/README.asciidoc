...
:revnumber: v0.1
:docdate: 2020-05-10
:ignore_files: all.pdf, all.asciidoc
:article_lang: fr
...
Le code se trouve link:https://github.com/archiloque/orm-ruby[ici].

Il manque quelques éléments pour qu'il soit vraiment utile, par exemple la gestion des `UPDATE` et de la suppression unitaire d'enregistrements, mais leur implémentation devrait largement s'appuyer sur le code existant.
