...
Historiquement les systèmes Unix et Linux utilisent pour cela un système appelé "`{syi}`" parce qu'il tire son origine de link:https://en.wikipedia.org/wiki/UNIX_System_V[la version 5 d'Unix] datant de 1983.
