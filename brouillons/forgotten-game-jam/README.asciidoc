...
The manual gave you crucial lore information on the relationship between the alien species, but we didn't had it.
...
Without the manual that explained the gameplay, we toured the place like tourists impressed by the visuals, fetching the few objects we could access without being caught.
