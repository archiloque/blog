...
Si je m'intéresse au lean original pour mieux comprendre son application aux projets informatiques, je ne pense pas que les deux sont ont les mêmes caractéristiques.
