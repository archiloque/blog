...
Developers can feel metal so use a ceramic knive. They will argue they know a better alternative to stabbing them that involves Kubernetes, Rust or both, but don't listen to them: it will you cost you a lot and will only makes thing worse.