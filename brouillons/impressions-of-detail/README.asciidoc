...
20 years ago it would have added some challenge, but with the internet they could stick to English, it just add a level of annoyance.

You pick your phone and look for a translation.

The word means "`cantaloupe`" in a language and "`piston`" in another.
...
The network cables has been coated with entropy-resistant material, and all the air in the server room has been swapped to an inert mixture.
