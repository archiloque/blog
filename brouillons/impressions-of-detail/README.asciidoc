...
With each mobile operating system generation, the process to submit applications to the vendor store had become more and more … we'll say elaborate.

The mechanical giant snake was impressive at first: you have to summon it by slowly recitating the release notes, and then it embarks on its mysterious journey, unless of course it became stuck in the desert zone because of a certificate problem.
