...
Une loi semblable semble s'appliquer aux _middleware_{nbsp}:
...
Tout d'abord il y a la connaissance et les on-dit{nbsp}: les procédures stockées et équivalent ont mauvaise réputation et ces outils sont mal connus et peu prestigieux.
