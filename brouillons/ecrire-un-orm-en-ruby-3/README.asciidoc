...
Même si cela ne fait pas partie du standard SQL, la majorités des bases de données de ce type fournissent des moyens d'accéder aux métadonnées comme les tables, les index{nbsp}…
