...
S'intéresser à ce qui se fait ailleurs peut être riche d'enseignements, mais on peut le faire sans fascination pour l'étranger, et en prenant en compte la réalité derrière la propagande, par exemple la réalité du travail dans l'industrie Japonaise.
