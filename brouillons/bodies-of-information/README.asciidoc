...
Dans quelle mesures les technologies que j'utilise pour créer mes outils est elle-même un problème{nbsp}?
Par exemple quelles sont les conséquences d'utiliser un outil open source développé par Facebook, compte tenu de ce qu'on sait de cette entreprise{nbsp}?
