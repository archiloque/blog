...
Par exemple quelles sont les conséquences d'utiliser un outil open source développé par Amazon Facebook ou Uber, compte tenu de ce qu'on sait de ces entreprises{nbsp}?
