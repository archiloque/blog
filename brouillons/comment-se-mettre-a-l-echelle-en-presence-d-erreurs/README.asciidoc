...
Pour un pileline, cela signifie généralement un horrible tas de fichiers temporaires pour sauvegarder le résultat de chaque sous-commande, et le résultat de découper les données d'entrée en 
