...
As I've explained link:../solveurs/[in a previous article] (in French), the main engine of a puzzle solver is a loop used to iterate until a solution is found.

image::graph.svg[width=731,height=513]

But, first I need to be able to initializee the loop, which means reading the levels from disk.
