...
ifdef::backend-pdf[]
image::../baba-is-you-1/graph1.png[width=784,height=468]
endif::[]
ifndef::backend-pdf[]
image::../baba-is-you-1/graph1.svg[width=784,height=468]
endif::[]
...
image::../baba-is-you-1/first-level1.png[title="The first level"]
...
Now the code reads a level from disk and the next article will start implementing the solving logic.