...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: graph1.mmd, graph1.png, graph2.mmd, graph2.png, level1.java, state1.java, state2.java, state3.java, statetrytogotest1.java, statetrytogotest2.java, tiles1.java, tiles2.java
...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-5/graph1.png[width=705,height=307,title="The existing algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-5/graph1.svg[width=720,height=322,title="The existing algo",align="center"]
endif::[]
...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-5/graph2.png[width=624,height=664,title="The new algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-5/graph2.svg[width=639,height=679,title="The new  algo",align="center"]
endif::[]
...
When baba tries to move a rock, the code need to iterate until it finds something that is not a rock, or until the end of the level is reached.

This time there is no signature change, only some code to add, which means it's easier to start with the tests:
