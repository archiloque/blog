...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-5/graph2.png[width=536,height=651,title="The new algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-5/graph2.svg[width=585,height=708,title="The new  algo",align="center"]
endif::[]
...
Now all behaviors visible for the first level are implemented.
