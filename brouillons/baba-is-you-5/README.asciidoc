...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-5/graph1.png[width=569,height=693,title="The algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-5/graph1.svg[width=584,height=708,title="The algo",align="center"]
endif::[]
