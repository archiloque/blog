...
Dans la pratique les spécifications sont très souvent incomplètes ou obsolète, de sorte qu'une certaine dépendance envers les personnes qui développent existe.
