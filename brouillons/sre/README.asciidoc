...
Et dans un certain nombre de cas, quand le projet a une complexité raisonnable et s'appuie sur des outils du marché, c'est bien parce que la plateforme de production n'est pas au niveau où elle devrait être : on contourne un problème systémique par des solutions locales.
