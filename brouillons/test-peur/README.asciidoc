= Les tests automatisés et le peur
Julien Kirch
v0.1, 2018-12-18
:article_lang: fr
...
Ces logiciels comportent des bugs, mais dans l'ensemble ils fonctionnent bien, ou en tout cas suffisament bien pour être utilisés, parfois massivement.
...
Le développement se fait alors littéralement contre la montre : faites passer les testes ou jetez vortre travail.
...
Cela est aussi valable pour les approches qu'on s'impose à soi-même.
...
Il faut inventer des manière de convaincre qui n'utilisent pas ces ressorts, où l'agile ne vaudra pas mieux que les pire caricatures qu'on fait de lui.