...
S'ils vous donné des idées pour coder votre propre ORM d'une manière différente, lancez-vous, tant que vous restez raisonable dans vos ambitions, nottament celle de l'utilisez en production.
