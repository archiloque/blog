...
Bien que la persistence et les queues soient des obstacles pour {tâches-courtes}, les inconvénients sont moins évident pour {tâche-longues}, mais les mêmes genres de choses peuvent mal se passer.
...
C'est pour cela que vous voulez une base de données.
