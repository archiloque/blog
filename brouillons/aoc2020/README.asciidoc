...
I hate the soft peer pressure and the idea of self-imposed mandatory homework to do everyday, so as each year I do them later so I can choose my pace to work on them.
