...
Contrary to the old walkthroughs, articles about video games can explain the game plot (when it's relevant) the kind of game, their mechanics and often shows screenshots.
But they still keep some of the mystery intact, it's not the same as playing (and for me reading article is not a replacement for playing).

I have a computer and a Switch so I could play many of them in a few minutes, and sometimes I buy a game after reading about it.
And feel betrayed when I pay for a game I don't have fun with, specially if it's a game from a genre I don't really like because it mean I probably half-expected I wouldn't enjoy it.
