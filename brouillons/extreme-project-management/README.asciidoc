...
. A steering committee, where you share the project's reports with the stakeholders and you can decide of the next steps.
...
It means that 10 iterations per weeks should be a lower-bound.
