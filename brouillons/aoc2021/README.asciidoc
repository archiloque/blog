...
Compared to link:../aoc2020/[last year], the problems was OKish but I didn't really have fun.
Maybe I'm now a bit too used to some types of problems (map exploration, interpreter), and the fun of discovery is not here any more, even when learning a new programming language.

Some exercices really fel tedious to me (but maybe it's because I failed to find a better solution).
