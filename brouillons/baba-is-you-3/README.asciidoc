...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: direction1.java, graph1.mmd, graph1.png, level1.java, state1.java, state2.java, state3.java, stateavailablemovementstest1.java, statetrytogotest1.java, statetrytogotest2.java
...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-3/graph1.png[width=667,height=490,title="The inner algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
image::../baba-is-you-3/graph1.svg[width=750,height=483,title="The inner algo",align="center"]
endif::[]
