...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: graph3.mmd, graph3.png, state2.java, state3.java, stateavailablemovementstest1.java, statetrytogotest1.java
...
ifeval::["{doctype}" == "book"]
Following the second part, we'll deal with the logic to find a solution to the first level.
endif::[]
ifeval::["{doctype}" != "book"]
Following link:../babis-you-2/[the second part], we'll deal with the logic to find a solution to the first level.
endif::[]

image::../baba-is-you-3/first-level.png[title="Here it is"]
...
ifdef::backend-pdf[]
image::../baba-is-you-3/graph3.png[width=750,height=483,title="The inner algo"]
endif::[]
ifndef::backend-pdf[]
image::../baba-is-you-3/graph3.svg[width=750,height=483,title="The inner algo"]
endif::[]
