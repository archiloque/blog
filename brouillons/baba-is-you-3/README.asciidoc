...
:docdate: 2019-05-09
:article_lang: en
:ignore_files: direction1.java, graph3.mmd, graph3.png, level3.java, state2.java, state3.java, state4.java, stateavailablemovementstest1.java, statetrytogotest1.java, statetrytogotest2.java
:article_image: first-level3.png
...
image::../baba-is-you-3/first-level3.png[title="Here it is",align="center",width=293,height=342]
...
ifeval::["{doctype}" == "book"]
image::../baba-is-you-3/graph3.png[width=667,height=490,title="The inner algo",align="center"]
endif::[]
ifeval::["{doctype}" != "book"]
...
The title of this part is "`finding _a_ solution`", because I'll first write the code to find a valid solution, with a simplified algo that don't cover all possible cases, then I'll update it to make it compliant with the game rules.
