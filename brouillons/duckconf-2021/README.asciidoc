...
J'ai plutôt été agacé par le talk.

Le point de départ c'est que la dette technique est la conséquence de choix fait consciemment pour tenir l'engagement pris sur le périmètre des sprints de développement.

Dans mon expérience une partie significative

Une description

Dette technique : choix de manière consciente, qui sont fait pour tenir le périmètre d'une itération, car on prend un engagement.
Même SCRUM ne parle pas 

Une partie des problèmes et les solutions correspondent aux discours de l'architecture hexagonale.

Mon expérience sur le sujet c'est que je ne suis pas convaincu que les niveaux d'indirections qu'elle pousse à ajouter valent la peine.

De plus, comme cette complexité fait partie du modèle, elle est difficile à discuter, car on a tendance à penser --pour reprendre leur classification-- qu'elle fait partie de la complexité "`essentielle`" du logiciel.

Les personnes qui ont fait du JEE 
...
Progiciels qui montent en maturité

Par contre le fait de caricaturer les opposants du Low Code en Donal Trump m'a mis physiquement mal à l'aise.
Je pense qu'on peut critiquer des technologies, même en se trompant ou en étant de mauvaise foi, sans être assimilé à une personne raciste et misogyne qui menace de mort ses opposant·e·s.

=== Réussir une "Conway Inversée" / Romain Vailleux

Moins de contexte et des équipes réduites orienté par rapport aux produit IT qu'on veut produire

https://teamtopologies.com

=== CovidTracker : la data au service de tous{nbsp}! / Guillaume Rozier
