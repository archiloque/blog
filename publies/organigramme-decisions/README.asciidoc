...
- le poids des structures de rattachement{nbsp}: si un des rattachement est en fait fictif, c'est à dire que la branche en question n'a pas de pouvoir réel, elle sera bien vite oubliée ;
