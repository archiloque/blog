...
Lorsqu'on utilise un cadre de programmation maintream, par exemple un langage de programmation grand public et une base de données SQL, de nombreuses abstractions nous facilitent la vie{nbsp}: systèmes d'objets, SQL ou ORM, sockets réseaux{nbsp}…
