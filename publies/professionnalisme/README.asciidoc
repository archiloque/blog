...
Et quand le ou la coach&#8201;—{nbsp}à qui il faut plaire pour ne pas avoir d`'ennui{nbsp}—&#8201;arrive en disant "`alors, c`'est fun d`'écrire des tests, hein ? 😉😉`", il faut accepter son test de loyauté et dire "`oui bien sûr`", ou être prêt·e à accepter les conséquences.
