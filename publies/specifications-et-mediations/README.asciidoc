...
L'utilisation d'outils de "`spécification executables`" comme link:https://cucumber.io[Cucmber] ou link:http://fitnesse.org/FitNesse.UserGuide.TwoMinuteExample[FitNesse] me laisse assez dubitatif.
