...
Comme son titre l'indique, il s'agit d'un livre sur la mesure et la gestion de la performance dans les organisations en s'intéressant particulièrement à l'activité de développement logiciel.
...
La conclusion exposée est que les personnes qui partagent son avis sur les différentes difficultés rencontrées quand il s'agit de mesurer les activités partagent son approche.
...
Selon les ressources citées par l'auteur, les personnes sont en général motivées pour faire un travail de qualité car c'est pour elles une source de satisfaction.
