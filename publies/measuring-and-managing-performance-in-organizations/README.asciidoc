...
La conclusion exposée est que les personnes qui partagent son avis sur les  difficultés rencontrées quand il s'agit de mesurer les activités partagent son approche.
