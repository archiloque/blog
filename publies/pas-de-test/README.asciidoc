...
Mais, il·elle ouvert à la discussion{nbsp}: avec les bon argument il·elle pourrait accepter de changer sa manière de faire si on arriver à le·a persuader que cette approche permet de sortir le projet au plus tôt.
...
link:https://twitter.com/jeromedisch[Jérôme] me signale un troisième type, le plus déprimant{nbsp}: la personne qui veut bien faire mais dans une organisation où ça n'est pas possible{nbsp}: pas de base de donnée pour les test, pas d'accès au métier pour poser des questions{nbsp}… 