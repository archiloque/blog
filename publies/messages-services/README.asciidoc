...
Le mot "`service`" n'est pas à jeter à la poubelle, car il définit un cas d'usage&#8201;—{nbsp}la communication synchrone en point à point{nbsp}—&#8201;très utile dans un SI.
