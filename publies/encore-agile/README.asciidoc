...
Je ne dis pas que cette influence est forcément négative, mais qu'elle peut l'être -- dans le contenu de ce qui est proposé, ou dans ce qui est oublié{nbsp}—&#8201;et qu'il faut donc se poser la question.
