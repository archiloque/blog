...
:revnumber: v0.1
:revdate: 2020-07-06
:ignore_files: all.asciidoc, all.xml, Menlo-Bold.ttf, Menlo-BoldItalic.ttf, Menlo-Italic.ttf, Menlo.ttf, NewYorkMedium-Bold.otf, NewYorkMedium-BoldItalic.otf, NewYorkMedium-Italic.otf, NewYorkMedium.otf, pdf.sh
:article_lang: fr
...
ifeval::["{doctype}" == "book"]
image:../ecrire-un-orm-en-ruby-2/schema_dark.svg[]
endif::[]
ifeval::["{doctype}" != "book"]
