...
:article_lang: en
:ignore_files: all.asciidoc, general-microfictions.asciidoc, generate.sh, impressions-of-detail.asciidoc, make-up-a-criminal.asciidoc, make-up-an-adventurer.asciidoc, making-up-monsters.asciidoc, making-up-robots.asciidoc, software-development.asciidoc, styles.css
