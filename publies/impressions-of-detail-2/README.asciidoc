...
At least most of the work were done by drones, so it wasn't so unpleasant if you could handle the dust.
But you still wonder who is paying to restore these ancients macro LCD screens: what kind of message would you want to show on a monitor with 100 meters wide pixels.
