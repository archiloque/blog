= Fiche de lecture{nbsp}: "How to Take Smart Notes"
Julien Kirch
v0.1, 2018-06-19
:article_lang: fr
...
* le ton est celui du _self-help_{nbsp}: enthousiaste et copineur, plein d'adjectifs merveilleux et fantastiques ;
...
* la solution proposée a un aspect totalisant{nbsp}: elle doit être suivie à la lettre et dans son ensemble, et elle demande un long investissement pour fonctionner, mais quand elle le fait elle change votre vie ;
