...
La solution la moins mauvaise est alors d`'identifer le type d`'action qui posent problème et en tenir compte lors des prises de décision et essayer de limiter ce type de projets&#8201;—{nbsp}même s`'ils seraient les plus utiles{nbsp}—&#8201;et plutôt préférer les solutions locales, même si elles donnent des résultats moindres.
