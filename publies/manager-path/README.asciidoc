...
Camille Fournier est de celle qui attend beaucoup du management et qui prend ce sujet au sérieux{nbsp}: manager ce n'est pas seulement donner des objectifs et demander des comptes, mais tout un ensemble d'activités qui demandent des compétences, du temps et des efforts.
Pour elle le bon fonctionnement d'une organisation nécessite un management à la hauteur.

Le texte s'adresse à tous les grades{nbsp}: depuis la personne qui débute, pour expliquer qui attendre de son·a manageur·euse, au manageur·euse d'équipe, puis au manageur·euse de manageurs·euses, jusqu'aux grades exécutifs comme CTO.
...
Parfois vous pouvez même avoir l'impression que les personnes viennent vous voir par facilité, alors qu'à votre avis, elles auraient du trouver si elles avaient fait un effort{nbsp}…
