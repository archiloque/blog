...
L'avis des personnes qui ont créé {s} est que&#8201;—{nbsp}si la philosophie d'Unix peut être pertinente pour la conception de certains types d'applications{nbsp}—&#8201;elle ne l'est pas pour tous les types de programmes, et notamment pour les systèmes en charge de gérer d'autres programmes.
