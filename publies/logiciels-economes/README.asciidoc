...
Il y a bien longtemps, GNU Emacs était considéré comme l'équivalent d'un "`logiciel d'entreprise`" car il nécessitait une quantité de mémoire importante, disponible seulement sur des machines haut de gamme.
