...
Le premier sujet -- link:https://fr.wikipedia.org/wiki/Arbre_B[les B-trees]{nbsp}—&#8201;s'en approche, discutant d'organisation mémoire et de l'atomicité des opérations dans les processeurs.
