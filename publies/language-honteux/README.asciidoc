= Billet d'humeur{nbsp}: j'❤️ les langages honteux
Julien Kirch
v0.1, 2018-10-10
:article_lang: fr
...
On me dit que c'est mal de vouloir utiliser un langage pareil{nbsp}: il n'est pas élégant, il est utilisé par des personnes qui ne savent pas ce qu'iels font, il est utilisé dans des entreprise qui ne sont pas _cool_.
...
J'❤️ php, NodeJS, Ruby, Python, Lua…
