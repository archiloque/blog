...
Pour un exemple simple : allez sur le site de streaming de jeux vidéos link:https://www.twitch.tv[Twitch] et ouvrez le premier flux diffusé par une femme.
...
Si vous avez envie d'aller vite pour résoudre un problème, vous feriez mieux au contraire de prendre le temps d'expliquer ce que vous faites : apprendre à débugger fait partie des choses à enseigner.
