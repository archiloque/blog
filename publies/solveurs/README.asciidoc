...
Plusieurs caractéristiques font que&#8201;—{nbsp}à mon avis{nbsp}—&#8201;il s'agit d'un bon exercice d'apprentissage ou de perfectionnement, par exemple pour découvrir un nouveau langage de programmation.
...
Si les règles des jeux sont faciles à comprendre, trouver la bonne structure de données et d'organisation de code pour les implémenter de manière lisible&#8201;—{nbsp}pour éviter que link:../gameplay-emergent/[la complexité du gameplay émergent ne se retrouve dans votre code]{nbsp}—&#8201; demande souvent un vrai effort{nbsp}: les solveurs sont remplis de listes, de tableaux associatif, de grappes d'objets{nbsp}…
...
Si&#8201;—{nbsp}comme vu plus haut{nbsp}—&#8201;il ne faut pas trop anticiper, mieux va avoir un peu exploré le jeu pour savoir à quoi s'attendre.
