...
Dis autrement : je pense beaucoup d'entreprises fondées après 2005 ne deviendront jamais client d'un vendeur comme IBM ou Oracle, en tous cas en l'état actuel des choses.
...
La situation classique _buy vs. build_ se transforme en _buy from cloud provider vs buy from another vendor vs build_ : qu'une solution soit fournie ou pas par le fournisseur de cloud devient important dans le choix.
...
Par contre ils peuvent copiner avec des entreprises sur ce modèle :
...
D'après ce que je lis dans des white papers, c'est le nouveau hype des éditeurs depuis quelques temps :
