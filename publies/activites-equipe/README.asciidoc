...
* un·e développeur·euse qui s'occupe du support ne sait pas combien de temps il·elle disposera pour développer de nouvelles fonctionnalités, il·elle ne doit pas se mettre sur le chemin critique du projet{nbsp};
