...
Une autre réponse possible est de s'organisr pour essayer de faire bouger les zones en convainquant les entreprises que ce qu'on a envie de faire leur est utile.
