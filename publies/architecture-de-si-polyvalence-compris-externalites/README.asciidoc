...
v0.1, 2019-01-22
:article_lang: fr
:article_description: Quel métier bizarre
...
En effet, une caractéristique, pour moi, de ce sujet, est que les réponses posées en archi de SI sont presque toujours des compromis :
...
Idéalement oui, mais dans la réalité ça n'est pas le cas :
...
. savoir identifier quels sont les pans du système qui seront touchés ;
. pour chacun des pans, parvenir à savoir si il ou elle en sait assez ou si de l'aide est nécessaire
...
. construire une expertise forte sur certains domaines au cœur de son métier, comme les questions d'intégrations de données, permettant d'être autonome ;
