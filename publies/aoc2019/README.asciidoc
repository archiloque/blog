...
And same for the things I disliked: the writing theme that add flavor but makes some problems harder to understand, and many exercises have edge cases that are not tested in the provided samples so it makes harder to check if things work as expected.
