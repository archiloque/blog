...
Avec l'informatique qui prend de plus en plus de place -- nous devenons toutes et tous link:https://fr.wikipedia.org/wiki/Manifeste_cyborg[des cyborgs] qui dépendent de ces outils -- c'est une question qu'on ne peut plus ignorer.
