...
Dans ces jeux rien n'est masqué de ce qu'on contrôle, et on peut à loisir modifier et remodifier son usine pour qu'elle tourne comme une machine bien huilée, justement car à -- l'inverse d'une machine physique{nbsp}—&#8201;aucun engrenage ne viendra gripper le mécanisme.
