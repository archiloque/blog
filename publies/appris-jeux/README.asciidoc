...
Dans cette situation la capacité à avoir un feedback rapide est très importante car c'est elle qui limite la vitesse de travail.
...
Dans l'informatique de gestion j'ai l'impression qu'on a beaucoup travaillé sur les tests automatisés comme manière avoir des feedbacks rapide en se passant d'avoir à construire l'intégralité du code, mais qu'on néglige parfois le build lui-même.
